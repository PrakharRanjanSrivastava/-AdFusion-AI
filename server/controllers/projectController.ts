   ...
   let isCreditDeducted = false;
    ...
    try {
        ...
        const prompt = {
            ...
            Output ecomerce-quality photo realistic imagery.
            ${userPrompt}`
        }
...
data:{credits: {decrement: 10}
    ...
    try {
        ...
        if(!operation.response.generatedVideos){
            throw new Error(operation.response.raiMediaFileredReasons[0])
        }
        ...
        await prisma.project.update({
            ...
            //remove video file from disk after the upload
