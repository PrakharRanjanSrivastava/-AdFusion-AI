    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          description="Upload your model and product images"
        />
    ...
    <div className="flex justify-between items-start">
      ...
      <div className="w-full">
        ...
        <div className="m-6 text-gray-300">
          ...
          <input type="text" id="productName" value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="Name you product" required className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"/>
        </div>
        <div className="m-6 text-gray-300">
        ...
        <div className="m-6 text-gray-300">
          <label className="black text-sm mb-4"> Aspect Ratio</label>
