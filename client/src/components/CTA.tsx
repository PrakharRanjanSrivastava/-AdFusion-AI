            ...
            <div className="container mx-auto max-w-3xl">
                <div className="rounded-3xl bg-linear-to-b from-violet-900/20 to-violet-900/5 border border-violet-500/20 p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Join thousand of brands creating ads with AI. No credit card required. Start creating now.
                        </motion.p>
                        <motion.div
                            initial={{ y: 60, opacity: 0 }}
                            whileInView={{ y: 0, opacity: 1 }}
                        ...
                        >{!user ?(<GhostButton onClick={()=>openSignIn()}  className="px-8 py-3 gap-2">
                                Start Creating Now <ArrowRightIcon size={20} />
                            </GhostButton>):(<GhostButton onClick={()=>{navigate('/generate');scroll(0,0)}} className="px-8 py-3 gap-2">
                                Start Generating Now <ArrowRightIcon size={20} />
                            </GhostButton>)}
