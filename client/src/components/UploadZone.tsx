...
// Note: I also updated 'lable' to 'label' here, make sure to update it in your types/index.ts too!
const UploadZone = ({label, file, onClear, onChange}: UploadZoneProps) => {
     return (
 <div className="relative group">
     {/* FIXED: Added $ before {file ? ...} and corrected typos like voilet to violet */}
     <div className={`relative h-64 rounded-2xl flex flex-col items-center justify-center bg-white/2 p-6 ${file ? 'border-violet-600/50 bg-violet-500/5' : 'border-white/10 hover:border-violet-500/30 hover:bg-white/5'}`}>
         {file ? (
             <>
